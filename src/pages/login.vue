        ...
        <Tabs v-model="loginType" class="w-full">
          ...
          <TabsContent value="account" class="mt-4">
            <form class="space-y-4" @submit="handleLogin">
              <div class="space-y-2">
                ...
                <Input id="username" v-model="username" type="text" placeholder="请输入用户名" :disabled="loading" />
              </div>
              <div class="space-y-2">
          ...
          <TabsContent value="phone" class="mt-4">
            <form class="space-y-4" @submit="handleLogin">
              <div class="space-y-2">
                ...
                <Input id="phone" v-model="phone" type="tel" placeholder="请输入手机号" :disabled="loading" />
              </div>
              <div class="space-y-2">
                <Label for="smsCode">验证码</Label>
                <div class="flex gap-2">
                  <Input id="smsCode" v-model="smsCode" type="text" placeholder="请输入验证码" class="flex-1" :disabled="loading" />
                  <Button type="button" variant="outline" :disabled="countdown > 0 || !phone || loading" @click="sendSmsCode">
                    {{ smsButtonText }}
                  </Button>
                </div>
              </div>
          ...
          <TabsContent value="qrcode" class="mt-4">
            <div class="flex flex-col items-center space-y-4">
              ...
              <p class="text-sm text-muted-foreground">请使用微信扫描二维码登录</p>
              <Button variant="outline" size="sm"> 刷新二维码 </Button>
            </div>
          </TabsContent>
        </Tabs>
